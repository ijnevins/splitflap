...
// --- ADD THIS INCLUDE (for WiFiClientSecure) ---
...
logger_(logger),
wifi_client_(), // <-- This now creates a WiFiClientSecure object
mqtt_client_(wifi_client_) { // <-- Pass the secure client to PubSub
